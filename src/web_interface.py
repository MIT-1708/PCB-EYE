"""
PCB-EYE Web Interface
==================================
A modern Streamlit web application for PCB defect detection using AI.
...
.stApp::after {
    ...
    top: 0; left: 0; right: 0; bottom: 0;
    background-image: 
        linear-gradient(rgba(18, 83, 93, 0.1) 1px, transparent 1px),
        linear-gradient(90deg, rgba(18, 83, 93, 0.1) 1px, transparent 1px);
...
.glass-card:hover {
    ...
    box-shadow: 
        0 15px 30px rgba(0, 195, 255, 0.2),
...
[data-testid="stSidebar"] > div:first-child {
    background: rgba(4, 15, 38, 0.95) !important;
    box-shadow: 
        5px 0 30px rgba(0, 195, 255, 0.1),
        inset -1px 0 2px rgba(0, 195, 255, 0.2);
...
.stTabs [aria-selected="true"] {
    ...
    box-shadow: 
        0 0 20px rgba(0, 195, 255, 0.2),
        inset 0 0 10px rgba(0, 195, 255, 0.1) !important;
}
.stTabs [data-baseweb="tab"] {
    background: transparent;
    border-radius: 12px;
...
class PCBDefectWebInterface:
    """Web interface for PCB defect detection using Streamlit. - MIT PATEL"""
    
    def __init__(self):
        """Initialize the web interface. - MIT PATEL"""
        st.set_page_config(
            page_title="PCB-EYE: PCB Defect Detection AI",
            page_icon="🔬",
            layout="wide",
    ...
    def _find_available_models(self):
        """Find available model files in the project directory. - MIT PATEL"""
        models = {}
    ...
    def main(self):
        """Main application interface. - MIT PATEL"""
        # Professional header
        st.markdown("""
    ...
    def _create_sidebar(self):
        """Create professional sidebar with configuration options. - MIT PATEL"""
        st.sidebar.markdown("""

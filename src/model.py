...
==========================
YOLOv8-based model for detecting defects in printed circuit boards.
...
class PCBDefectDetector:
    """PCB Defect Detection Model using YOLOv8. - MIT PATEL"""
    
    def __init__(self, config_path: str = "config.yaml", model_path: Optional[str] = None):
        """Initialize the PCB defect detector. - MIT PATEL"""
    ...
    def train(self, data_yaml_path: str, epochs: Optional[int] = None):
        """Train the model on PCB defect dataset. - MIT PATEL"""
        if epochs is None:
    ...
    def predict_image(self, image_path: str, save_result: bool = True) -> Dict:
        """Predict defects in a single image with robust error handling and validation. - MIT PATEL"""
        try:
            # Validate image path
    ...
    def predict_batch(self, image_paths: List[str]) -> List[Dict]:
        """Predict defects in multiple images. - MIT PATEL"""
        results = []
    ...
    def live_detection(self, camera_id: int = 0, save_video: bool = False):
        """Perform live defect detection using webcam. - MIT PATEL"""
    ...
    def _annotate_frame(self, frame: np.ndarray, result) -> np.ndarray:
        """Annotate frame with detection results. - MIT PATEL"""
    ...
    def _save_detection_result(self, image: np.ndarray, detections: List[Dict], 
                             original_path: str):
        """Save detection result with annotations. - MIT PATEL"""
    ...
    def evaluate(self, test_data_yaml: str) -> Dict:
        """Evaluate model performance on test dataset. - MIT PATEL"""
    ...
    def export_model(self, format: str = 'onnx'):
        """Export model to different formats. - MIT PATEL"""
...
class PCBDefectClassifier(nn.Module):
    """Additional classifier for defect type classification. - MIT PATEL"""
